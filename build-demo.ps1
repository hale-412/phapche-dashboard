...
<script src="vendor/supabase-2.117.1.min.js"></script>
...
<script src="js/demo-data.js?v=13"></script>
'@
$h = [regex]::Replace($h, '<script src="vendor/supabase-[^"]+"></script>\s*<script src="js/config\.js\?v=13"></script>', $inject.Replace('$', '$$'))
